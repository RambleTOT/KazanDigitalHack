...
class OnBoardingFragment : Fragment() {
    ...
    private val variant1: Array<String> = arrayOf("Пенсионер", "Часто занимаюсь спортом", "Да, часто хожу", "Да, посещаю", "Да, часто езжу", "Концерты", "Ежедневно", "Автобус", "Часто", "Цена")
